(function () {
  ...
  Object.assign(dictionary, {
    ...
    "Figuras como desactivado en este procedimiento.": "Figures com a desactivat en aquest procediment.",
    "Consulta la información oficial del procedimiento para verificar tu situación administrativa.": "Consulta la informació oficial del procediment per a verificar la teua situació administrativa.",
    "Ver detalle de adjudicación": "Veure detall de l'adjudicació",
    "Bolsa docente": "Borsa docent",
    "Consta en bolsa docente": "Consta en borsa docent",
    "Figura en un listado de bolsa o participantes de inicio de curso cargado en la web.": "Figura en un llistat de borsa o de participants d'inici de curs carregat en la web.",
    "Posiciones detectadas en listados de bolsa o participantes de inicio de curso.": "Posicions detectades en llistats de borsa o de participants d'inici de curs.",
    "Fecha": "Data",
    "Curso": "Curs",
    "Listado": "Llistat",
    "Ámbito": "Àmbit",
    ...
    "Posición en bolsa": "Posició en borsa",
    "Estado bolsa": "Estat borsa",
    "General": "General",
    "Por especialidad": "Per especialitat",
    "Bolsa general": "Borsa general",
    "Bolsa por especialidad": "Borsa per especialitat",
    "habilitación desactivada": "habilitació desactivada",
    "No hay registros de bolsa docente.": "No hi ha registres de borsa docent.",
    "Histórico de adjudicaciones": "Històric d'adjudicacions",
    "Detalle técnico de las adjudicaciones registradas.": "Detall tècnic de les adjudicacions registrades.",
    "No hay adjudicaciones registradas.": "No hi ha adjudicacions registrades.",
    "Participaciones y selecciones registradas.": "Participacions i seleccions registrades.",
    "Resultado": "Resultat",
    "Seleccionado": "Seleccionat",
    "Participante": "Participant",
    "No hay registros de difícil cobertura.": "No hi ha registres de difícil cobertura.",
    "registros de difícil cobertura": "registres de difícil cobertura",
    "registros de bolsa": "registres de borsa",
    "Siguiente paso orientativo": "Següent pas orientatiu",
    "Sí tienes una plaza adjudicada en los datos cargados.": "Sí que tens una plaça adjudicada en les dades carregades.",
    "Consulta la resolución oficial y el centro adjudicado para los siguientes pasos administrativos.": "Consulta la resolució oficial i el centre adjudicat per als passos administratius següents.",
    "Revisa futuras publicaciones definitivas o adjudicaciones.": "Revisa futures publicacions definitives o adjudicacions.",
    "Sin resumen": "Sense resum",
    "Consulta el detalle histórico disponible en la tabla inferior.": "Consulta el detall històric disponible en la taula inferior.",
    "Selecciona una persona": "Selecciona una persona",
    "Primero debes buscar y seleccionar una coincidencia": "Primer has de buscar i seleccionar una coincidència",
    "Esta página muestra la ficha de la persona seleccionada desde el buscador. No contiene el identificador en la URL.": "Aquesta pàgina mostra la fitxa de la persona seleccionada des del cercador. No conté l'identificador en l'URL.",
    "Perfil no disponible": "Perfil no disponible",
    "Centro / localidad": "Centre / localitat",
    "Código puesto": "Codi lloc",
  });
