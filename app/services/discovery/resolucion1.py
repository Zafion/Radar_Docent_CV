...
class Resolucion1Adapter(BaseDiscoveryAdapter):
    ...
    def discover_assets(self) -> list[DiscoveredAsset]:
        ...
        for anchor in soup.find_all("a", href=True):
            ...
            downloadable = self._looks_like_downloadable_document(absolute_url)
            ...
            results.append(
                DiscoveredAsset(
                    ...
                    publication_label="Difícil cobertura",
    ...
    def _classify_asset_role(self, title: str) -> str | None:
        ...
        if "listado de participantes" in text and "provisional" in text:
            return "provisional_listado_pdf"

        if "puestos definitivos ofertados" in text:
            return "puestos_definitivos_pdf"

        if "nota informativa" in text:
            return "nota_informativa_pdf"

        if "turnos d.t." in text:
            return "turnos_dt_pdf"
